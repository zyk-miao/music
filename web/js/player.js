...
class PlayerCreator {
    ...
    get_now_info() {
        let song_time = this.audio.currentTime;
        let song_id = this.song_index;
        let song_status = this.audio.paused;
        let info = {"song_time": song_time, "song_id": song_id, "song_status": song_status};
        return info;
    }
    ...
    bindEventListener() {
        ...
        this.audio.onended = () => {
            ...
            this.my_change('next');
            let info = player.get_now_info();
            info.song_status=false;
